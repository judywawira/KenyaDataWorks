// Define some views that utilizes the autogenerated backbone models defined in schema.js
...
var JobListView = Backbone.View.extend({
    ...
    initialize: function(params) {
        _.bindAll(this, 'render');
        // Try to fetch jobs from Captricity. If it failed, log it.
        this.failedFetch = false;
        this.collection = new captricity.api.Jobs();
        this.collection.bind('reset', this.render, this);
        // Check to see if we want to filter the jobs. If a filter is specified, pass that along as GET parameters to the schema url.
